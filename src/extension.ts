...
export function activate(context: vscode.ExtensionContext) {
  ...
  disposables.push(
    vscode.commands.registerCommand('red-hour.setMeetingTime', async () => {
  ...
  disposables.push(
    vscode.commands.registerCommand('red-hour.cancelMeetingTime', () => {
      meetingTime = null;
      setBackgroundColor(originalBgColor);
      vscode.window.showInformationMessage('Meeting effect cancelled and color reset.');
    })
  );
